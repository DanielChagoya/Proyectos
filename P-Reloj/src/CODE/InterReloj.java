 ...
 */
public class InterReloj extends javax.swing.JFrame {

    /**
     * Creates new form InterReloj
     */
    public InterReloj() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        txtHora.setFont(new java.awt.Font("Dialog", 0, 36)); // NOI18N
        ...
        txtMinutos.setFont(new java.awt.Font("Dialog", 0, 36)); // NOI18N
        txtMinutos.setHorizontalAlignment(javax.swing.JTextField.CENTER);

        txtSegundos.setFont(new java.awt.Font("Dialog", 0, 36)); // NOI18N
    ...
    private void btInicioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btInicioMouseClicked
        Reloj rh = new Reloj(txtHora, txtMinutos, txtSegundos);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterReloj.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterReloj().setVisible(true);
            }
        });
    }
